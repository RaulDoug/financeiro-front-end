...
## T-024 — Saldos das Contas e Resumo de Cartões [concluida]
- Refs: AC-030, AC-031
...
## T-025 — Seção de Transações Recentes e Ordenação [concluida]
- Refs: AC-033, AC-034
...
## T-026 — Alertas de Atrasos e Estado Tudo em Dia [concluida]
- Refs: AC-039, AC-040
...
## T-027 — Ações Rápidas de Lançamento e Store Global [concluida]
- Refs: AC-041, AC-042
...
## T-028 — Gráfico de Barras Receitas vs Despesas com Seletor de Ano [concluida]
...
## T-029 — Gráfico de Rosca Despesas por Categoria [concluida]
...
## T-030 — Orquestração de Dados com TanStack Query [concluida]
