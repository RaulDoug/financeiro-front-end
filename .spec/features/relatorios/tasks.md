...
## T-064 — Integração da API de Relatórios (Dashboard) [pendente]
...
## T-065 — Layout da Tela de Relatórios e Navegação [pendente]
...
## T-066 — UI do DRE / Comparativo Anual [pendente]
...
## T-067 — UI de Despesas por Categoria [pendente]
...
## T-068 — Cálculo e Agrupamento de Contrapartes [pendente]
...
## T-069 — UI de Gastos por Contraparte [pendente]
...
## T-070 — Refinamentos de Visualização e Tratamento de Erros [pendente]
