...
## T-001 — Configuração do Store e Interceptor Axios [concluida]
- Refs: US-003, AC-008
...
## T-002 — Serviços de API (Login e Register) [concluida]
...
## T-003 — Layout Base de Autenticação [concluida]
- Refs: US-001, US-002
...
## T-004 — Página de Login [concluida]
...
## T-005 — Página de Registro [concluida]
...
## T-006 — Página de Recuperação de Senha (Placeholder) [concluida]
...
## T-007 — Guardas de Rota Privadas/Públicas [concluida]
...
## T-008 — Integração Geral das Rotas de Auth [concluida]
