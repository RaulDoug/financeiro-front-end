...
## T-009 — Lógica Global de Redirecionamento para Onboarding [concluida]
...
## T-010 — Serviços de API da Configuração Inicial [concluida]
- Refs: US-004, US-005
...
## T-011 — Estrutura Base e Layout do Wizard (Stepper) [concluida]
- Refs: US-004, US-005
...
## T-012 — Step 1: Criação da Carteira [concluida]
- Refs: US-004, AC-014
...
## T-013 — Step 2: Criação da Conta Bancária Inicial [concluida]
...
## T-014 — Step 3: Cartão de Crédito Opcional e Finalização [concluida]
