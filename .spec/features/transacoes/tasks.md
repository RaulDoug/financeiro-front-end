...
## T-031 — Tipos TypeScript para transações [pendente]
...
## T-032 — Service de comunicação com API de transações [pendente]
...
## T-033 — Hooks TanStack Query para transações com rolagem infinita [pendente]
...
## T-034 — Componente de filtros da listagem [pendente]
...
## T-035 — Tabela de listagem de transações com IntersectionObserver [pendente]
...
## T-036 — Schemas Zod de validação [pendente]
...
## T-037 — Modal de transação com abas [pendente]
...
## T-038 — Formulário base de transação [pendente]
...
## T-039 — Lógica do checkbox "Já está pago" [pendente]

- Refs: AC-050
- Arquivos: src/components/transactions/TransactionFormBase.tsx
- Notas: Ao marcar, define payment_date = hoje automaticamente.

## T-040 — Seletor de categorias filtrado por tipo [pendente]
...
## T-041 — Campos de parcelamento e recorrência [pendente]
...
## T-042 — Mutations de criação de transação [pendente]
...
## T-043 — Edição de transação e parcelas em lote [pendente]
...
## T-044 — Diálogo de exclusão com confirmação [pendente]
